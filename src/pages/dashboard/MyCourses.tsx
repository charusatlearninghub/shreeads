...
const MyCourses = () => {
  ...
  return (
    <DashboardLayout title="My Courses" subtitle="Continue learning where you left off">
      {/* Promo Code Banner */}
      <motion.div
      ...
      {isLoading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6" data-sensitive="true">
